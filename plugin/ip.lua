...
-- IPv4 and IPv6 return:
-- { type, bytes, size } where bytes is an array of 2-byte values.
...
-- @see				IPv6
-- @see				Hex
function M.IPv4(address, netmask)
...
-- @see				IPv4
-- @see				Hex
function M.IPv6(address, netmask)
...
-- @see				IPv4
-- @see				IPv6
function M.Hex( hex, prefix, family, swap )

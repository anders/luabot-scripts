local names = {
  ...
  'Rainer', 'Guillaume', 'Walter', 'Andrei', 'Butt', 'Linus'
}
local commits = {
  ...
  "should work I guess...",
  "cba",
  "don't know why this works but it does so... commit"
}

local msg = pickone(commits)

msg = msg:gsub('XNAMEX', function()
  return pickone(names)
end)

msg = msg:gsub('XUPPERNAMEX', function()
  return pickone(names):upper()
end)

msg = msg:gsub('XLOWERNAMEX', function()
  return pickone(names):lower()
end)

return ('%s (%d lines added, %d lines removed)'):format(msg, math.random(0, 100), math.random(0, 100))